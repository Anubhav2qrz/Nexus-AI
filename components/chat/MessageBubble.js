      ...
      <div className={`max-w-[80%] md:max-w-[70%] ${isUser ? 'items-end' : 'items-start'} flex flex-col gap-1`}>
        <div
          ...
          style={{
            ...
            boxShadow: isUser
              ? '0 2px 12px rgba(20,184,166,0.2)'
              : 'var(--shadow)',
          }}
        >
          {isUser ? (
              ...
              {isStreaming && !message.content ? (
                ...
                <ReactMarkdown
                  ...
                  components={{
                    ...
                    pre({ children }) {
                      // If the pre doesn't have a code block with a language, render a generic code block
        ...
        {/* Copy button — appears on hover for non-streaming messages */}
        {!isStreaming && message.content && (
